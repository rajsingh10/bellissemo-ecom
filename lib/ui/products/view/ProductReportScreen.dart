...
class _ProducatReportScreenState extends State<ProducatReportScreen> {
  ...
  void initState() {
    ...
    print("yearList generated: $yearList"); // 🔥 DEBUG: Check if 2025 is in list
...
setState(() {
  ...
  void didChangeDependencies() {
    ...
    print("didChangeDependencies called - selectedYear: $selectedYear"); // 🔥 DEBUG
  }

  @override
  Widget build(BuildContext context) {
    print("Build called - selectedYear: $selectedYear, yearList: $yearList"); // 🔥 DEBUG
                      ...
                      child: Container(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton<int>(
                            ...
                            onChanged: (value) {
                              print("Year changed to: $value"); // 🔥 DEBUG
                              setState(() {
                                selectedYear = value;
                              });
                      ...
                      child: Container(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton<int>(
                            ...
                            onChanged: (value) {
                              print("Month changed to: $value"); // 🔥 DEBUG
                              setState(() {
                                selectedMonth = value;
                              });
                              _fetchCustomerReport();
  ...
  Future<void> _fetchCustomerReport() async {
    print("_fetchCustomerReport called with year: $selectedYear, month: $selectedMonth"); // 🔥 DEBUG
