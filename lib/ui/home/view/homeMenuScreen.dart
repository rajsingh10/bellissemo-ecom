...
class _HomeMenuScreenState extends State<HomeMenuScreen> {
  ...
  Orientation? _lastOrientation; // To track orientation changes
  ...
  /// Extracted the main UI content to avoid duplication
              ...
              Container(
                ...
                child: Padding(
                  padding: EdgeInsets.only(
                    // Adjust top padding if sidebar is present (no status bar overlap usually)
                    top: showSideBar ? 4.h : 6.5.h,
                    right: 3.w,
                    left: 3.w,
                  ),
                  child: Column(
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: isIpad ? 2.h : 3.h),
                          Wrap(
                            spacing: 0.w,
                            runSpacing: 3.h,
                          ...
                          SizedBox(height: isIpad ? 3.h : 5.h),
                          CustomButton(
                            title: 'Explore More..',
  ...
  Widget _buildMenuItem(String svgPath, String title) {
    ...
    // Adjust width calculation slightly for sidebar mode to fit better
    if (100.w >= 800 &&
        MediaQuery.of(context).orientation == Orientation.landscape) {
      // With sidebar, available width is less (100.w - 8.w)
      // You might want to recalculate itemWidth here if things overlap
      // but typically wrap handles it.
    }
  ...
  // ... [The rest of your methods (_fetchProfile, _fetchCustomers, _clearCart, _showSelectCustomerDialog, getTokenApi) remain exactly the same as your original code] ...
  ...
  getTokenApi() async {
    ...
    if (token == null || token.isEmpty) {
      // Handle missing token if necessary, or just return
      return;
    }
